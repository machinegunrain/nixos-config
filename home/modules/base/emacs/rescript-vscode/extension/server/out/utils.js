...
let findRescriptBinary = (binaryDirPath) => {
    return (0, exports.findBinary)(binaryDirPath, c.rescriptBinName);
};
exports.findRescriptBinary = findRescriptBinary;
let findBscBinary = (binaryDirPath) => {
    return (0, exports.findBinary)(binaryDirPath, c.bscBinName);
};
exports.findBscBinary = findBscBinary;
let formatCode = (bscPath, filePath, code) => {
